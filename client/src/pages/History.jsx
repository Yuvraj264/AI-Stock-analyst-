...
import { ArrowLeft, RefreshCw, BarChart2, ShieldAlert, Award, FileText, ArrowUpRight } from 'lucide-react';
            ...
            {history.map((record) => {
              ...
              return (
                <div
                  ...
                  className="group relative flex flex-col justify-between p-6 rounded-2xl bg-white dark:bg-slate-900 border border-slate-100 hover:border-emerald-500/40 dark:border-slate-800 dark:hover:border-emerald-500/40 shadow-sm transition-all duration-300 hover:-translate-y-1 cursor-pointer"
                >
                  <div>
                    {/* Header */}
                    <div className="flex items-start justify-between">
                      <div>
                        <h3 className="text-lg font-bold text-slate-800 dark:text-white group-hover:text-emerald-500 transition-colors duration-200">
                          {record.companyName}
                        </h3>
                      ...
                      <span
                        className={`inline-flex items-center px-2.5 py-1 rounded-md text-xs font-bold border ${getRecommendationBadgeStyle(
                    ...
                    <div className="grid grid-cols-3 gap-2 mt-6">
                      <div className="p-2 rounded-lg bg-slate-50 dark:bg-slate-950 border border-slate-100 dark:border-slate-800/80 text-center">
                        ...
                        <span className="text-[10px] font-semibold text-slate-400 uppercase block">Score</span>
                  ...
                  <div className="flex items-center justify-between mt-6 pt-4 border-t border-slate-50 dark:border-slate-800">
                    ...
                    <span className="text-xs font-semibold text-emerald-500 group-hover:translate-x-1 transition-transform duration-200 flex items-center gap-1">
